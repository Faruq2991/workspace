...
if prompt_1 == "left":
    prompt_1 = input("You come to a river you must cross. Do you walk or swim: ")
    if prompt_1 == "swim":
    ...
    prompt_1 = input("You arrived at an old wobbly bridge. Do you wish to cross (Yes/No): ")
    if prompt_1 == "yes":
        prompt_1 = input("You crossed and met an old man at the other side. Do you engage or ignore him (engage/ignore): ")
    elif prompt_1 == "no":
